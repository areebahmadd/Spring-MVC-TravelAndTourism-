		...
		<thead>
			...
			<c:forEach items="${hotels }" var="hotels">
				<tr>
					...
					<th id="">
					<a href = "updateHotel/${hotels.id}" class = "fas fa-user-edit" style ="font-size: 25px;" ></a>
               		<a href = "deleteHotel/${hotels.id}" class = "fas fa-user-slash rediconcolor" style ="font-size: 25px;" ></a>
					</th>
				</tr>
			</c:forEach>
		</thead>
